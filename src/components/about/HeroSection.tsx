...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[95vh] flex items-center overflow-hidden pt-24 pb-16">
                      ...
                      <button
                        ...
                        className={`h-14 w-14 rounded-2xl flex flex-col items-center justify-center transition-all duration-500 relative ${
                          isSelected
                            ...
                            : 'bg-white border-2 border-black text-[#FC9E00] hover:bg-[#FC9E00]/10 hover:scale-105 hover:shadow-md'
                        }`}
                        style={isSelected ? {
                          background: 'radial-gradient(circle at 30% 30%, #FD7C06, #e06a00)',
                          boxShadow: '0 8px 32px rgba(253,124,6,0.4), inset 0 1px 0 rgba(255,255,255,0.2)',
                          border: 'none'
                        } : undefined}
                      >
                        {isSelected && (
                          <>
                            ...
                            <div className="absolute -inset-1 rounded-2xl bg-gradient-to-br from-[#FC9E00]/30 via-[#FD7C06]/10 to-transparent blur-sm -z-10" />
                            <div className="absolute inset-0 rounded-2xl ring-2 ring-[#FC9E00]/30 ring-offset-2 ring-offset-white/10" />
                          </>
                        )}
                        ...
                        {isSelected && (
                          <div className="absolute -right-3 top-1/2 -translate-y-1/2 hidden md:flex items-center justify-center">
                            <div className="flex items-center justify-center h-6 w-6 rounded-full bg-white shadow-lg shadow-[#FD7C06]/20">
                              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#FD7C06" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
