            ...
            return (
              <div key={inv.id} className="flex items-center gap-4 rounded-2xl border border-border-gray bg-white p-4">
                ...
                <div className="text-right">
                  ...
                  {inv.invoiceUrl && <a href={inv.invoiceUrl} className="text-[10px] text-gold hover:underline flex items-center gap-0.5 justify-end"><Download className="h-3 w-3" /> PDF</a>}
                </div>
              </div>
            )
          })}
