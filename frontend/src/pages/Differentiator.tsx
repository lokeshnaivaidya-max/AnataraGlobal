    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div>
              ...
              <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
                ...
                What Makes <span style={{ color: '#FD7C06' }}>Antara Global</span> Different
              </motion.h1>
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden" style={{ backgroundColor: '#000000' }}>
        <div className="absolute inset-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full blur-3xl" style={{ backgroundColor: 'rgba(253,124,6,0.06)' }} />
        </div>
        <div className="absolute top-0 left-0 w-full h-px" style={{ background: 'linear-gradient(to right, transparent, #FD7C06, transparent)' }} />
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            ...
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              ...
              <div className="relative mb-8 text-center">
                <h3 className="text-3xl sm:text-4xl font-extralight tracking-wide text-white">
                  We Are <span className="font-bold" style={{ color: '#CEA041' }}>Not</span>
                </h3>
              </div>
                  ...
                  return (
                    <motion.div key={item.label}
                      ...
                      <div className="flex items-start gap-3">
                        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg" style={{ backgroundColor: '#CEA041' }}>
                          <Icon className="h-4 w-4" style={{ color: '#FFFFFF' }} />
                        </div>
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <h4 className="font-semibold text-sm text-white">{item.label}</h4>
                            <span className="text-[10px] uppercase tracking-wider font-semibold" style={{ color: '#FF0000' }}>✕ Not</span>
                          </div>
                          <p className="mt-0.5 text-xs font-light" style={{ color: 'rgba(255,255,255,0.4)' }}>{item.desc}</p>
                        </div>
                        <span className="text-lg font-light shrink-0" style={{ color: '#CEA041' }}>✕</span>
                      </div>
                    </motion.div>
                  )
                })}
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              ...
              <div className="rounded-2xl p-6 sm:p-7 mb-6 text-white text-center relative overflow-hidden shadow-lg border"
                ...
                <div className="absolute top-[-50%] right-[-20%] w-[200px] h-[200px] rounded-full" style={{ backgroundColor: 'rgba(253,124,6,0.05)' }} />
                ...
                {areItems.map((item, idx) => {
                  ...
                  return (
                    <div key={item.title}
                      ...
                      style={{ backgroundColor: '#000000', borderColor: '#B46A29' }}
                      onMouseEnter={(e) => e.currentTarget.style.borderColor = '#FD7C06'}
                      onMouseLeave={(e) => e.currentTarget.style.borderColor = '#B46A29'}>
                      <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
                        <div className="flex sm:flex-col items-center sm:items-center gap-3 sm:gap-2 sm:w-20 shrink-0">
                          <div className="flex h-12 w-12 items-center justify-center rounded-xl" style={{ backgroundColor: '#F57504' }}>
