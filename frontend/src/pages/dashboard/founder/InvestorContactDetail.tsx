                ...
                <div key={c.id} className="flex items-start gap-3 rounded-xl bg-light-gray/50 p-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-medium-gray/60 mt-1">
                      {c.type} &middot; {new Date(c.date).toLocaleDateString('en-IN', { day: 'numeric', month: 'short' })}
              ...
              {meetings?.map(m => (
                <div key={m.id} className="rounded-xl border border-border-gray p-3">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-[10px] text-medium-gray">{new Date(m.date).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}</span>
                  </div>
