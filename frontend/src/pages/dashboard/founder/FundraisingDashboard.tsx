        ...
        >
          ...
          <div className="flex items-center justify-between text-sm mb-2">
            ...
            <span className="font-bold text-deep-navy">
              ${(activeRound.raisedAmount ?? 0).toLocaleString()} / ${(activeRound.targetAmount ?? 0).toLocaleString()}
            </span>
          </div>
          <div className="h-3 rounded-full bg-light-gray overflow-hidden">
            <motion.div
              initial={{ width: 0 }}
              animate={{ width: `${activeRound.targetAmount ? Math.min(((activeRound.raisedAmount ?? 0) / activeRound.targetAmount) * 100, 100) : 0}%` }}
