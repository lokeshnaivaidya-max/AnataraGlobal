  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="space-y-4">
        {rounds?.map((round, i) => {
          const progress = round.targetAmount > 0 ? Math.min((round.raisedAmount / round.targetAmount) * 100, 100) : 0
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-3 text-sm">
                <div className="flex items-center gap-1 text-medium-gray">
                  ...
                  <span className="font-bold text-deep-navy">{round.currency} {round.raisedAmount.toLocaleString()}</span>
                  <span className="text-medium-gray">/ {round.currency} {round.targetAmount.toLocaleString()}</span>
                </div>
