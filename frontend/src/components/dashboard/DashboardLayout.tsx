...
export default function DashboardLayout({ children, navItems }: { children: ReactNode; navItems: DashboardNavItem[] }) {
  ...
  return (
    <div className="flex min-h-screen bg-light-gray">
      <aside className={`
        fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-border-gray transform transition-transform duration-300 lg:translate-x-0 lg:static lg:z-auto flex flex-col h-screen overflow-hidden
        ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}
      `}>
        <div className="flex items-center justify-between h-16 px-6 border-b border-border-gray flex-shrink-0">
        ...
        <div className="p-4 border-t border-border-gray flex-shrink-0 bg-white">
