...
export default function Footer() {
  return (
    <footer className="relative bg-deep-navy text-white overflow-hidden">
      ...
      <div
        className="absolute -bottom-20 -left-20 w-64 h-64 rounded-full bg-emerald/5 blur-3xl animate-float"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 group">
              <img
                src="/image.png"
                alt="Antara Global Logo"
                className="h-14 w-auto object-contain transition-transform duration-300 group-hover:scale-105"
              />
            </div>

            <p className="mt-4 text-white/40 text-sm leading-relaxed max-w-md">
              Strategic business advisory, venture readiness, and capital
              connectivity ecosystem helping businesses prepare, connect, and
              grow.
            </p>
        ...
        <div className="mt-14 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6 text-xs text-white/30">
            <a
              href="#"
              className="hover:text-gold-light hover:underline transition-all"
            >
              Privacy Policy
            </a>
