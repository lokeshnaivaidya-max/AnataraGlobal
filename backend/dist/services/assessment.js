...
exports.calculateReadinessChecklistScore = calculateReadinessChecklistScore;
exports.calculateDiagnosticEngineScores = calculateDiagnosticEngineScores;
function calculateReadinessChecklistScore(answers) {
    const items = [
        'businessPlan',
        'pitchDeck',
        'financialModel',
...
function calculateDiagnosticEngineScores(answers) {
